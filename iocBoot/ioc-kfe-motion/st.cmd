...
epicsEnvSet("MOTOR_PREFIX",    "PLC:KFE:MOTION:")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:KFE:MOTION")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:KFE:MOTION")
